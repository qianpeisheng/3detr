...
CUDA_VISIBLE_DEVICES=3 python3 main_SDCoT_pseudo_2_source_distill_ema.py \
...
--ema_nms_threshold 0.25 \
--use_cls_threshold \
--use_dynamic_threshold \
--dynamic_div_by first \
--checkpoint_dir ckpts_scannet/debug_7_no_aux_d_c_scannet_SDCoT_14_4_dynamic_cls_threshold_first \
