...
CUDA_VISIBLE_DEVICES=2 python3 main_SDCoT_pseudo_only.py \
...
--enc_type vanilla \
--test_only \
--test_ckpt /home1/peisheng/3detr/ckpts_scannet/scannet_SDCoT_9_9_pseudo_distill_vanilla/checkpoint_0200.pth
