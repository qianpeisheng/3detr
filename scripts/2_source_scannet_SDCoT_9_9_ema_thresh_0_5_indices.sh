...
CUDA_VISIBLE_DEVICES=1 python3 main_SDCoT_pseudo_2_source_distill_ema_indices.py \
...
--loss_center_consistency_weight 0.5 \
--loss_cls_consistency_weight 5. \
--loss_size_consistency_weight 2. \
--use_ema_pseudo_label \
--ema_nms_threshold 0.9 \
--checkpoint_dir ckpts_scannet/2_source_scannet_SDCoT_9_9_ema_thresh_0_9 \
