...
CUDA_VISIBLE_DEVICES=1 python3 main_SDCoT_pseudo_2_source_distill_ema_v2.py \
...
--checkpoint_dir ckpts_scannet/2_source_scannet_SDCoT_9_9_low_conf_ema_thresh_0_25 \
