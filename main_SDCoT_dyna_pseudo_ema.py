...
def make_args_parser():
    ...
    parser.add_argument('--loss_center_consistency_weight', type=float, default=1.,
                        help='use consistency loss with given weight')
    parser.add_argument('--loss_cls_consistency_weight', type=float, default=1.,
                        help='use consistency loss with given weight')
    parser.add_argument('--loss_size_consistency_weight', type=float, default=1.,
                        help='use consistency loss with given weight')
    parser.add_argument('--ema_decay', type=float,
                        default=0.999, help='ema variable decay rate')
    parser.add_argument('--use_ema_pseudo_label', action='store_true',
                        default=False, help='use ema model to generate pseudo labels')
...
def main(local_rank, args):
    ...
    if args.use_ema_pseudo_label:
        datasets['train'].set_ema_model(ema_model)
