...
class ScannetDatasetConfig_incremental(object):
    def __init__(self, num_base_class=NUM_CLASS_BASE, num_incremental_class=NUM_CLASS_INCREMENTAL):
        ...
        # select only classes between self.num_semcls_base and self.num_semcls_base_and_inc, i.e., the incremental classes
        self.type2class = {
        ...
        self.nyu40ids = self.nyu40ids[self.num_semcls_base: self.num_semcls_base_and_inc]
...
class ScannetDetectionDataset_incremental(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
