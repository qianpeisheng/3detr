...
CUDA_VISIBLE_DEVICES=0 python3 main_SDCoT_pseudo_2_source_distill_ema_free_match.py \
...
--checkpoint_dir ckpts_scannet/free_match_2_source_scannet_SDCoT_9_9_ema_thresh_0_5 \
