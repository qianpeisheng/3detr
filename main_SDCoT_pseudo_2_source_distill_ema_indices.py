...
from datasets import build_dataset_Pseudo_2_source_EMA  # build_dataset_SDCoT
from engine_distill_ema_2_source_indices import evaluate, train_one_epoch, evaluate_incremental
...
def main(local_rank, args):
    ...
    datasets, dataset_config_train, dataset_config_val, dataset_config_base = build_dataset_Pseudo_2_source_EMA(
        args)
