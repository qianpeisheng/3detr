...
from utils.eval_det_debug import eval_det_multiprocessing, get_iou_obb
        ...
        if config_dict["per_class_proposal"]:
            ...
            for ii in range(config_dict["dataset_config"].num_semcls):
                cur_list += [
                    ...
                    and obj_prob[i, j] > 0.05
                    and sem_cls_probs[i, j, ii] > 0.
                ]
