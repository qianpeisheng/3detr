...
CUDA_VISIBLE_DEVICES=0 python3 main_SDCoT_pseudo_2_source_distill_ema.py \
...
--dynamic_div_by last \
--checkpoint_dir ckpts_scannet/debug_7_no_aux_d_c_scannet_SDCoT_9_9_dynamic_cls_threshold_last \
